    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm() {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'storebase_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_storebase_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    protected function _getAdditionalElementTypes() {
        return ['image' => 'Excellence\Storebase\Block\Adminhtml\Form\Element\Image'];
    }
}
